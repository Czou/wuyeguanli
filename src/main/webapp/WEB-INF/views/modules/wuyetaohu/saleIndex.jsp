...
<body>
	...
	<form:form id="inputForm" modelAttribute="user"  action="${ctx}/wuyetaohu/dictTaohu/sale" method="post" class="form-horizontal">
		<sys:message content="${message}"/>
		<form:hidden path="taohuId" />
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="mobile" htmlEscape="false" maxlength="18" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
